    ...
    <w-grid :gapY="4">
      ...
      <w-grid cols="12">
        <div
          v-for="i in 12"
          :key="i"
          class="grid-box grow rounded-none h-16 border border-white dark:border-primary-900 centered"
        >
          {{ i }}
        </div>
      </w-grid>
    ...
    <w-grid :gapY="4">
      ...
      <w-grid cols="12" :gap="1">
        <div
          v-for="i in 36"
          :key="i"
          class="rounded h-12 text-white dark:border-primary-900 centered"
          :class="bgColors[i % 5]"
        >
          {{ i }}
        </div>
    ...
    <w-grid :gapY="4">
      ...
      <w-grid cols="4" :rows="6" :gap="1" show-lines>
        ...
        <w-grid-item :rowStart="3" :rowEnd="7" :colStart="2" :colEnd="4">
          <div class="grid-box--default h-full bg-primary-300">
