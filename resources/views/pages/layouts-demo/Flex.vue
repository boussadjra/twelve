    ...
    <v-flex space-y="4" dir="col">
      ...
      <v-flex space-x="2">
        <div
          v-for="i in 4"
          :key="i"
          class="bg-secondary-300 dark:bg-secondary-900 rounded text-black-600 dark:text-white p-4 w-32"
        >
          lorem ipsum
        </div>
      </v-flex>
        ...
        <card v-for="pos in justifyAlignments" :key="pos" class="w-full" elevation="sm">
          ...
          <v-flex :justify="pos" :spaceX="2">
            <div
              v-for="i in 4"
              :key="i"
              class="bg-secondary-300 dark:bg-secondary-900 rounded text-black-600 dark:text-white p-2 w-32"
            >
              lorem ipsum
            </div>
          </v-flex>
      ...
      <v-flex space-y="12" dir="col">
        <card v-for="pos in alignments" :key="pos" class="w-full h-64" elevation="sm">
          ...
          <v-flex
            :align="pos"
            :spaceX="2"
            class="h-40 bg-primary-100 dark:bg-primary-900"
          >
            <div
              v-for="i in 4"
              :key="i"
