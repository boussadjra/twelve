  ...
  <div class="p-16 bg-white dark:bg-black-700 min-h-screen">
    <card>
      ...
      <div class="w-92 p-8">
        ...
        <button
          class="mt-8 px-8 py-2 bg-gray-800 text-primary-100 shadow-md rounded-full self-end focus:outline-none hover:bg-primary-900"
        >
          <a
        ...
        <button
          class="ml-2 mt-8 px-8 py-2 bg-yellow-600 text-primary-100 shadow-md rounded-full self-end focus:outline-none hover:bg-primary-900"
        >
          <a
