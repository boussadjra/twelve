  ...
  <div class="flex flex-row justify-around py-4">
    <div class="flex flex-wrap p-2 w-full">
      <div
        ...
        :title="icon"
        class="p-2 m-1 bg-primary-100 dark:bg-black-800 w-12 h-12 flex items-center justify-center rounded-full cursor-pointer text-gray-600 dark:text-gray-50 hover:text-gray-100 hover:bg-primary-500"
      >
  ...
  <div class="py-4 flex justify-center">
    <div class="flex">
      <span
        role="button"
        @click="page--"
        class="p-4 bg-primary-600 dark:bg-primary-400 text-gray-100 rounded-full m-2 hover:bg-primary-800 cursor-pointer"
      >
        <IconCaretLeft />
      </span>
      <span
