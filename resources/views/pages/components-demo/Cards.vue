<template>
        ...
        <template #footer>
          <div class="flex space-x-8 ml-4 items-end justify-around">
            <IconFavorite
              height="24"
              width="24"
              class="text-gray-600 dark:text-gray-400 cursor-pointer hover:text-primary-600"
            />
            <IconChat
              height="24"
              width="24"
          ...
          <div class="flex space-x-2 items-center w-full justify-between pb-4">
            <div class="flex space-x-2 items-center w-full">
              <w-avatar
                ...
                shape="rounded-full"
                size="sm"
                class="flex bg-primary-200 text-primary-100 row-start-1 row-end-3 text-primary-650 ring-1 ring-white"
              >
              </w-avatar>
  ...
  <div class="space-y-2">
    ...
    <div class="w-full grid--auto-cols gap-4">
      <card
        class="w-full bg-gradient-to-r from-primary-900 to-primary-700 text-primary-50 rounded-md"
      >
        <template #header>
